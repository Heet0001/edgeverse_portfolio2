...
import {
  FALLBACK_ADVISORS,
  FALLBACK_LEADERS,
} from "../../pages/leadership/leadershipData";
import styles from "../../pages/leadership/leadership.module.scss";
...
const LeadershipTeamSection = ({ embedded = false }: { embedded?: boolean }) => {
