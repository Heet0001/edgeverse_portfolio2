...
const ProductHeroSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(
        section.querySelectorAll(`.${styles.badge}, .${styles.heading}, .${styles.subtitle}, .${styles.cta}`),
        {
          y: 24,
          opacity: 0,
          duration: 0.75,
  ...
  return (
    <section ref={sectionRef} id="page-hero" className={styles.section} aria-label="Product hero">
